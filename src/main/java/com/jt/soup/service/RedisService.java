...
public class RedisService {
	...
	public void delList(String catlistname) {
		
	}

	public void lpush(String catlistname, String itemCatUrl) {
		
	}

	public Long llen(String catlistname) {
		return null;
	}

	public String lindex(String catlistname, int i) {
		return null;
	}

	public void sadd(String itemsetname, String itemUrl) {
		
	}

	public void incr(String catlistkeypos) {
		
	}

	public String spop(String itemsetname) {
		return null;
	}
